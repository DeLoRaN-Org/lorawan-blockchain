...
export ORDERER_GENERAL_LOCALMSPDIR="${PWD}"/crypto-config/ordererOrganizations/dlwan.phd/orderers/orderer3.dlwan.phd/msp
export ORDERER_GENERAL_TLS_ENABLED=true
export ORDERER_GENERAL_TLS_PRIVATEKEY="${PWD}"/crypto-config/ordererOrganizations/dlwan.phd/orderers/orderer3.dlwan.phd/tls/server.key
export ORDERER_GENERAL_TLS_CERTIFICATE="${PWD}"/crypto-config/ordererOrganizations/dlwan.phd/orderers/orderer3.dlwan.phd/tls/server.crt
...
export ORDERER_GENERAL_TLS_ROOTCAS="${PWD}"/crypto-config/ordererOrganizations/dlwan.phd/orderers/orderer3.dlwan.phd/tls/ca.crt
