...
export CORE_PEER_TLS_CERT_FILE="${PWD}"/crypto-config/peerOrganizations/org1.dlwan.phd/peers/peer1.org1.dlwan.phd/tls/server.crt
export CORE_PEER_TLS_KEY_FILE="${PWD}"/crypto-config/peerOrganizations/org1.dlwan.phd/peers/peer1.org1.dlwan.phd/tls/server.key
...
export CORE_PEER_ID=peer1.org1.dlwan.phd
...
export CORE_PEER_MSPCONFIGPATH="${PWD}"/crypto-config/peerOrganizations/org1.dlwan.phd/peers/peer1.org1.dlwan.phd/msp
export CORE_OPERATIONS_LISTENADDRESS=127.0.0.1:8447
export CORE_PEER_FILESYSTEMPATH="${PWD}"/data/peer1.org1.dlwan.phd
export CORE_LEDGER_SNAPSHOTS_ROOTDIR="${PWD}"/data/peer1.org1.dlwan.phd/snapshots
