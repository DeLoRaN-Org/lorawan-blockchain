...
export PATH=/opt/fabric/bin:/opt/fabric/builders/ccaas:"$PATH"
...
export ORDERER_GENERAL_LOCALMSPDIR=/opt/fabric/crypto/orderer.dlwan.phd/msp
export ORDERER_GENERAL_TLS_ENABLED=true
export ORDERER_GENERAL_TLS_PRIVATEKEY=/opt/fabric/crypto/orderer.dlwan.phd/tls/server.key
export ORDERER_GENERAL_TLS_CERTIFICATE=/opt/fabric/crypto/orderer.dlwan.phd/tls/server.crt
...
export ORDERER_GENERAL_TLS_ROOTCAS=/opt/fabric/crypto/orderer.dlwan.phd/tls/ca.crt
